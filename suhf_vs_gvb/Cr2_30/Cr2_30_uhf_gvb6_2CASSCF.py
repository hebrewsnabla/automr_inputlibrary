...
mf.mo_coeff = fch2py('Cr2_30_uhf_uno_asrot2gvb6_s.fch', nbf, nif, 'a')
# read done
...
copyfile('Cr2_30_uhf_uno_asrot2gvb6_s.fch', 'Cr2_30_uhf_gvb6_2CASSCF_NO.fch')
py2fch('Cr2_30_uhf_gvb6_2CASSCF_NO.fch',nbf,nif,mc.mo_coeff,'a',mc.mo_occ,True)
