...
mf.mo_coeff = fch2py('Cr2_20_uhf_SUHFNO.fch', nbf, nif, 'a')
# read done
...
copyfile('Cr2_20_uhf_SUHFNO.fch', 'Cr2_20_uhf_SUHFNO_CASSCF_NO.fch')
py2fch('Cr2_20_uhf_SUHFNO_CASSCF_NO.fch',nbf,nif,mc.mo_coeff,'a',mc.mo_occ,True)
