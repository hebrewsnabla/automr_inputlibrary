...
alpha_coeff = fch2py('Cr2_20_uhf.fch', nbf, nif, 'a')
beta_coeff = fch2py('Cr2_20_uhf.fch', nbf, nif, 'b')
...
os.system('fch_u2r Cr2_20_uhf.fch')
os.rename('Cr2_20_uhf_r.fch', 'Cr2_20_uhf_uno.fch')
py2fch('Cr2_20_uhf_uno.fch',nbf,nif,mf.mo_coeff[0],'a',noon,True)
# save done
...
copyfile('Cr2_20_uhf_uno.fch', 'Cr2_20_uhf_uno_asrot.fch')
noon = np.zeros(nif)
py2fch('Cr2_20_uhf_uno_asrot.fch',nbf,nif,mf.mo_coeff[0],'a',noon,False)
